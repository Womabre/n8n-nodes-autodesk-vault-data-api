...
- [n8n community nodes docs](https://docs.n8n.io/integrations/community-nodes/build-community-nodes/)
- [n8n creating nodes docs](https://docs.n8n.io/integrations/creating-nodes/overview/)
- [n8n nodes build reference](https://docs.n8n.io/integrations/creating-nodes/build/reference/)
